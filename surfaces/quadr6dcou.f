...
C     ----------------------------------------------------------------
C     -6dim Coulomb potential for 2 electrons, quadratically decaying-
C     ----------------------------------------------------------------
C     INPUT:
...
C     v     : Coulomb potential energy in au
      ...
      subroutine quadr6dcou(x1,y1,z1,x2,y2,z2,v)      

C     externally used variables
      real*8  x1,y1,z1,x2,y2,z2,v
C     internally used variables
      real*8  a,b,x,y,z,r              

      a = 0.01              ![a.u.], parameter
      b = 100.0              ![a.u.], parameter

      x = x1-x2
      y = y1-y2
      z = z1-z2

      r = a**2 * exp(-b*(x**2+y**2+z**2)) !regularization parameter

      v = 1.D0/sqrt(x**2+y**2+z**2+r)

!      write(*,*)'x1-z2,r,v',x1,y1,z1,x2,y2,z2,r,v
