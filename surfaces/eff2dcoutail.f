...
C     v     : Coulomb potential energy in au
      ...
      subroutine eff2dcoutail(z1,z2,v)      
...
C     internally used variables
      ...
      m = 1.0d0    ![a.u.], mass should be the same as in the op fil

      w = 1.0d0   ![a.u.]

       alfa = 0.1d0
      !l = sqrt(80.d0/(658.4092645439*2.d0))*0.052917720859
      a = 0.5d0*sqrt(40.d0/658.4092645439)*0.052917720859
      !sqrt(m*w/2.d0), 1/sqrt(2)/l 
      ...
      z0= 22.00
      if ( z > z0 ) then
        v = exp(-alfa*(z-z0))/abs(z1-z2)
      else if ( z > 20.00 ) then ! after this the erf doesn't work
        v = 1.d0/abs(z1-z2)
      else
      logv= z**2 + log(erfc(z))      
      v = b*a*exp(logv)
